...
class Loader
{
    ...
    public function loadSubmissionHeader($data): SubmissionHeader
    {
        ...
        if (!isset($data[SubmissionHeader::JOB_ID_KEY])) {
            throw new JobConfigLoadingException(
                "Submission header does not contain the required field '" . SubmissionHeader::JOB_ID_KEY . "'"
            );
        }
        ...
        if (!isset($data[SubmissionHeader::HARDWARE_GROUPS_KEY])) {
            throw new JobConfigLoadingException(
                "Submission header does not contain the required field '" . SubmissionHeader::HARDWARE_GROUPS_KEY . "'"
            );
        } else {
            if (!is_array($data[SubmissionHeader::HARDWARE_GROUPS_KEY])) {
                throw new JobConfigLoadingException(
                    "Submission header field '" . SubmissionHeader::HARDWARE_GROUPS_KEY . "' does not contain an array"
                );
            }
        }
    ...
    public function loadTask($data): Task
    {
        ...
        if (!isset($data[Task::TASK_ID_KEY])) {
            throw new JobConfigLoadingException(
                "Task configuration does not contain required field '" . Task::TASK_ID_KEY . "'"
            );
        }
        ...
        if (!isset($data[Task::CMD_KEY]) || !is_array($data[Task::CMD_KEY])) {
            throw new JobConfigLoadingException(
                "Task '" . $taskId . "' does not contain proper field '" . Task::CMD_KEY . "'"
            );
        }
    ...
    public function loadJobConfig($data): JobConfig
    {
        ...
        if (!isset($data[JobConfig::SUBMISSION_KEY])) {
            throw new JobConfigLoadingException(
                "Job config does not contain the required field '" . JobConfig::SUBMISSION_KEY . "'"
            );
        }
        ...
        if (!isset($data[JobConfig::TASKS_KEY])) {
            throw new JobConfigLoadingException(
                "Job config does not contain the required field '" . JobConfig::TASKS_KEY . "'"
            );
        }
