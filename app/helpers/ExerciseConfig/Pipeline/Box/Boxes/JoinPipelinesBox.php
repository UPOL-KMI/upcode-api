...
class JoinPipelinesBox extends Box
{
    ...
    public function compile(CompilationParams $params): array
    {
        ...
        if (
            ($inputVariable->getValue() === $outputVariable->getValue()) ||
        ...
        if ($inputVariable->isValueArray() && $outputVariable->isValueArray()) {
            ...
            if (count($inputVariable->getValue()) !== count($outputVariable->getValue())) {
                throw new ExerciseCompilationException(
                    "Different count of remote variables and local variables in box '{$this->getName()}'"
                );
            }
            ...
            if (!$inputVariable->isValueArray() && !$outputVariable->isValueArray()) {
                ...
                throw new ExerciseCompilationException(
                    "Incompatible types of variables in joining box '{$this->getName()}'"
                );
            }
        }
